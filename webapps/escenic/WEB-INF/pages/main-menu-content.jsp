...
<div class="content">
  <ul>
    <% if(checker.isGlobalPublicationAdmin(publication.getId())){ %>
      <li><html:link page="/publication/view.do" styleClass="frontpageLink"><bean:message key="m.admin.Publication"/></html:link></li>
      <li><html:link page="/section/search.do" styleClass="frontpageLink"><bean:message key="m.admin.Section"/></html:link></li>
    <%}%>
    <% if(checker.isGlobalPublicationAdmin(publication.getId())){ %>
      <li><html:link page="/publication/xmlimport.do" styleClass="frontpageLink"><bean:message key="m.admin.ImportArticles"/></html:link></li>
      <li><html:link page="/publication/viewArticleTypes.do" styleClass="frontpageLink"><bean:message key="m.admin.ArticleTypes"/></html:link></li>
      <li><html:link page="/publication/viewTemplates.do" styleClass="frontpageLink"><bean:message key="m.admin.Templates"/></html:link></li>
    <%}%>
    ...
    <%}%>
    <li><a href="javascript:submitForm('action:/person/refresh.do')" class="frontpageLink"><bean:message key="m.admin.Refresh"/></a></li>
...
<% if (checker.canDoPersonSearch() || checker.canDoGroupSearch()) { %>
<div class="create-article content-box">
<div class="header">
