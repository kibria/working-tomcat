...
<% 
  ...
  String countryString= ((Locale)session.getAttribute(lang)).getLanguage().toLowerCase();
  String language = "calendar-en.js";//defaults to english
  if(countryString.equals("no")){
    language = "calendar-no.js";
  }
  language = "/script/lang/"+language;
%>  

<link rel="stylesheet" href="<html:rewrite page='/css/calendar-win2k-1.css' />" type="text/css">
<script type="text/javascript" src="<html:rewrite page='/script/calendar.js' />"></script>
<script type="text/javascript" src="<html:rewrite page='<%=language%>' />"></script>
<script type="text/javascript" src="<html:rewrite page='/script/calendar-setup.js' />"></script>
