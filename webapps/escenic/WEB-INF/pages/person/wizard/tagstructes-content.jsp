...
<input type="hidden" name="validateInput"  value="tagStructures"/>
...
<table  class="listing" cellpadding="0" cellspacing="0">
    ...
    <tr class="all">
      ...
      <td><input type="checkbox" name="all" onclick="markAll();" id="AllTags"></td>
    </tr>
    <logic:iterate name="form" property="tagStructures.keys" id="_sec" >
      ...
      <tr>
          ...
          <td><html:checkbox property="<%=roleAttr%>" styleClass="tagRole"/></td>          
      </tr>      
    </logic:iterate>
</table>
...
<tr>
 ...
 <td>&nbsp;</td>
 <td><a href="javascript:submitForm('contentTypes')" class="global-button">Next</a></td>
 <td>&nbsp;</td>
